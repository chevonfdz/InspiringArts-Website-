...
//validate personal info and payment form after pressing buynow button.
function validateForm(){
      ...
      if (fname == "" || lname=="" || email == "" || phone == "" || adr == "" || city =="" || country =="" || cname=="" || ccnum =="" || expmonth== "" || expyear==""|| cvv==""){
        alert("Please fill all the mandotory fields before submitting");
        return false;
      }else{
        alert("Check out our website for more Arts products. Thank you");
      }
  }